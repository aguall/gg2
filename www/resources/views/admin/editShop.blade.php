	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li><a href="/master/shops">Список магазинов</a></li>
			...
			<div class="col-md-12">
				...
				{!! Form::open(['class' => 'form-horizontal', 'role' => 'form', 'files' => true]) !!}
					...
					<div class="form-group">
						<div class="col-sm-12">
							{!! Form::select('visible', [0 => 'Не показывать магазин', 1 => 'Показывать магазин'], $post->visible, ['class' => 'form-control']); !!}
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-12">
							<div class="input-group">
								<span class="input-group-btn">
									<span class="btn btn-primary btn-file">
										<i class="fa fa-picture-o"></i> <input type="file" name="logo" />
									</span>
								</span>
								<input type="text" class="form-control" id="image" value="{{ $post->logo }}" placeholder="Логотип магазина" readonly>
							</div>
						</div>
					</div>
							...
							<div class="col-sm-3">
								<div class="panel panel-default image-prev">
									<div class="panel-body">
										<img src="/uploads/shops/{{ $post->logo }}" alt="{{ $post->name_ru }}" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-group">
						{!! Form::label('rating', 'Рейтинг магазина', ['class' => 'col-sm-2 control-label']) !!}
						<div class="col-sm-10">
							{!! Form::text('rating',  $post->rating, ['class' => 'form-control']) !!}
						</div>
					</div>
