	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li><a href="/master/shop/filters/features-options/{{ $feature->id }}">Опции параметра: "{{ $feature->name }}"</a></li>
			...
			<div class="col-md-12">
				...
				{!! Form::open(['class' => 'form-horizontal', 'role' => 'form']) !!}
					...
					<div class="languages-content active">
						<div class="form-group">
							<div class="col-sm-12">
								{!! Form::text('name_ru',  $post->name_ru, ['class' => 'form-control', 'placeholder' => 'Название опции параметра']) !!}
							</div>
						</div>
					</div>
					...
					<div class="languages-content">
						<div class="form-group">
							<div class="col-sm-12">
								{!! Form::text('name_ua',  $post->name_ua, ['class' => 'form-control', 'placeholder' => 'Название опции параметра']) !!}
							</div>
						</div>
					</div>
					...
					<div class="languages-content">
						<div class="form-group">
							<div class="col-sm-12">
								{!! Form::text('name_en',  $post->name_en, ['class' => 'form-control', 'placeholder' => 'Название опции параметра']) !!}
							</div>
						</div>
					</div>
					<div class="form-group">
