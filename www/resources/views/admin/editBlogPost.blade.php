	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li><a href="/master/blog/posts">Записи</a></li>
		...
		<div class="row">
			<div class="col-md-12">
				...
				{!! Form::open(['class' => 'form-horizontal', 'role' => 'form', 'files' => true]) !!}
					...
					<div class="form-group">
						<div class="col-sm-12">
							{!! Form::select('visible', [0 => 'Не показывать запись', 1 => 'Показывать запись'], $post->visible, ['class' => 'form-control']); !!}
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-12">
					...
					<div class="form-group">
						<div class="col-sm-12">
							<div class="input-group">
								...
								{!! Form::date('date', !empty($post->date) ? $post->date : \Carbon\Carbon::now(), ['class' => 'form-control', 'title' => 'Дата публикации']); !!}
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-12">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="image" value="{{ $post->image }}" placeholder="Выбирите миниатюру..." readonly>
							</div>
						</div>
					</div>
							...
							<div class="col-sm-3">
								<div class="panel panel-default image-prev">
									<div class="panel-body">
										<img src="/uploads/blog/{{ $post->image }}" alt="{{ $post->name_ru }}" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="languages-content">
						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="record_ua">
								...
								<div class="form-group">
									{!! Form::label('annotation_ua', 'Аннотация', ['class' => 'col-sm-2 control-label']) !!}
									<div class="col-sm-10">
										<textarea name="annotation_ua" id="annotation_ua" class="form-control" rows="3">{{ $post->annotation_ua }}</textarea>
									</div>
								</div>
								<div class="form-group">
